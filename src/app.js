document.addEventListener('alpine:init', () => {
    Alpine.data('products', () => ({
        ...
        items: [
            ...
            { id: 3, name: 'Capuchinno Latte', img: '3.jpg', price: 32000 },
            { id: 4, name: 'Mochacinno Latte', img: '4.jpg', price: 35000 },
            { id: 5, name: 'Primo Passo', img: '5.jpg', price: 30000 },
        ],
    }));
...
//mengecek apakah form sudah di isi semua, maka tombol checkout aktif
...
checkoutButton.addEventListener('click', async function (e) {
    ...
    window.open('http://wa.me/6287884960137?text=' + encodeURIComponent(message));
